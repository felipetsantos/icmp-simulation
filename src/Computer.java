...
public class Computer extends Node {
        ...
        */
        ...
        private void sendMsg(String dstIpAddr, String msg) {
                Package pkt = new Package(dstIpAddr, this.interfaces[0].getIpAddr(), msg);
         ...
         * 
         * @param pkt Objeto {@link Package} com a mensagem a ser impressa.
         */
        private void printPkt(Package pkt) {
	...
	public void run() {
         ...
         * @param pkt Pacote {@link Package} a ser encaminhado
         * @param srcPort Número da porta {@link int} que recebeu o pacote 
         */
        protected void forwardPkt(Package pkt,int srcPort) {
        ...
        protected void recivePkt(Package pkt,int port) {
            ...
            if(!pkt.hasMoreFragment){
                ...
                Package pktRebuiled = pkt.rebuildPkt(buffer);
