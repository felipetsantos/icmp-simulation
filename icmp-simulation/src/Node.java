...
public class Node implements CSProcess {
	 ...
	 * 
	 * @param pkt Objeto {@link Package} recebido;
	 * @return <code>true</code> se o pacote foi destinado a este nodo;
	 *         <code>false</code> caso contrario;
	 */
	protected boolean checkPkt(Package pkt) {
	...
	public void run() {
        ...
        protected void processIn(int interfaceNumber){
                                ...
                                Package pkt;
                                pkt = (Package) interfaces[port].getIn().read();
				//if (checkPkt(pkt)){
    ...
    protected void forwardPkt(Package pkt,int port) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }


    protected  void fragmentPkt(Package pkt) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
